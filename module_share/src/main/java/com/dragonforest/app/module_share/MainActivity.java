...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.btn_share_link) {
            showBroadView();
        } else if (i == R.id.btn_share_music) {
        } else if (i == R.id.btn_share_video) {
        } else if (i == R.id.btn_share_image) {
        }
    }
    ...
    private void shareLink(String platform) {
        //这里以分享链接为例
        ShareParams shareParams = new ShareParams();
        shareParams.setShareType(Platform.SHARE_WEBPAGE);
        shareParams.setTitle("分享链接");
        shareParams.setText("哈哈");
        shareParams.setShareType(Platform.SHARE_WEBPAGE);
        shareParams.setUrl("https://www.jiguang.cn/dev2/#/app/8f7823b73bf352c226787f7b/info");
