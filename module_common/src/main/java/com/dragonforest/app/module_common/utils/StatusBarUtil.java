...
public class StatusBarUtil {
    ...
    public void setTopPaddding(Context context, ViewGroup topViewGroup){
        // 设置头部padding
        int paddingTop=getStatusBarHeight(context);
        int paddingRight = topViewGroup.getPaddingRight();
        int paddingLeft = topViewGroup.getPaddingLeft();
        int paddingBottom = topViewGroup.getPaddingBottom();
        topViewGroup.setPadding(paddingLeft,paddingTop,paddingRight,paddingBottom);
    }
}
